...
from prepdocslib.textsplitter import SentenceTextSplitter, SimpleTextSplitter, CodeLinesSplitter
...
def setup_file_processors(
    ...
    code_lines_splitter = CodeLinesSplitter()
    ...
    file_processors = {
        ...
        ".for": FileProcessor(TextParser(), code_lines_splitter),
        ".f90": FileProcessor(TextParser(), code_lines_splitter),
    }
